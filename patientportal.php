...
<section>
  ...
  <a href="/login.php" class="btn btn-primary text-center mt-2" style="margin-left: 150px; min-width: 200px; padding-left: 30px; padding-right: 30px; min-height: 50px; font-weight: 600; font-style: normal; padding: 11px 22px; border-color: white;"> Already Registered?  Access A Patient Portal</a>
    </div>
  <!-- </div>
  </div> -->
  </div>
  ...
  <a href="/signup.php" class="btn btn-primary text-center mt-2" style="margin-left: 150px; min-width: 200px; padding-left: 30px; padding-right: 30px; min-height: 50px; font-weight: 600; font-style: normal; padding: 11px 22px; border-color: white;">Register Online for Patient Portal</a>
    </div></div>
